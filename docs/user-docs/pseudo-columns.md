...
|------------------------------------------|------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|----------------------------------------------------|
| Normal Columns                           | `"col"`, `"id"`                          | `{"source": "col"}`, `{"source": "id"}`                                                                                                                                               | All                 |                                                    |
...
| Inbound ForeignKey Columns               | `["s", "fk2_cons"]`, `["s", "fk3_cons"]` | `{"source": [{"inbound": ["s", "fk2_cons"]}, "f2_id"], "entity": true}`, `{"source": [{"inbound": ["s", "fk3_cons"]}, {"outbound": ["s", "main_f3_cons"]}, "f3_id"], "entity": true}` | detailed            | Inline Table                                       |
