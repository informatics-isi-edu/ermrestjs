...
exports.execute = function (options) {
  describe('PseudoColumn, ', function () {
    ...
    var mainEntityUri = options.url + '/catalog/' + catalog_id + '/entity/' + schemaName + ':' + tableName + '@sort(main_table_id_col)';

    var invalidEntityUri = options.url + '/catalog/' + catalog_id + '/entity/' + schemaName + ':' + invalidAnnotTableName + '/main_table_id_col=01';

    var mainEntityUriNoAggVal =
      options.url +
      '/catalog/' +
      catalog_id +
      '/entity/' +
      ...
      ':' +
      tableName +
      '/main_table_id_col=1111;main_table_id_col=1112;main_table_id_col=1113';
    ...
    var detailedExpectedNames = [
      'main_table_id_col',
      'col',
      'vMKDORVxEGDzdAwQEH0pJA',
      'xRrChcQgxGIr0CNyYQtQ0Q',
      'o7Gpk7dRlnzNv3_JjhqDIg',
      'CaEhWBd7gSjuYCLun-8D-A',
      '1EC_6-rbhKc3tIjczjq1fQ',
      'GUABhSm2h_kaHHPGkzYWeA',
      'gNTPCP0bGB0GRwFKEATipw',
      'nGwW9Kpx5sLf8cpX-24WNQ',
      '0utuimdZvz8kTU4GI7tzWw',
      'PEQDZ38621T5Y9J3P2Te2Q',
      'plpeoINYqVjmca9rYYtFuw',
      'OpHtewN91L9_3b1Vq-jkOg',
      'LHC_G9Tm_jYXQXyNNrZIGA',
      'H3B-cJhnO5kI08bThBIMxw',
      'ZJll4WjE6eMk_g5e9WE1rg',
      'GFBydDhuUocHxUlF894ntQ',
      'vd-zzWca-ApLn2yvu7fx1w',
      '8siu02fMCXJ2DfB4GLv93Q',
      'OLbAesieGW5dpAhzqTSzqw',
      'MJVZnQ5mBRdCFPfjIOMvkA',
      'asset',
      'asset_filename',
      'IKxB9JkO83__MmKlV0Nnow',
      'wjUK75uqILcMMo85UxnPnQ',
      '$virtual-column-1',
      '$virtual-column-1-1',
    ...
    beforeAll(function (done) {
      ...
      options.ermRest
        .resolve(mainEntityUri, { cid: 'test' })
      ...
      detailedExpectedValue = [
        ...
        '<p>01: col val 01</p>\n',
        '01',
        '<a href="https://example.org/chaise/record/pseudo_column_schema:outbound_1/RID=' +
          utils.findEntityRID(options, schemaName, 'outbound_1', 'id', '01') +
          '">01</a>',
        '<p>01: 10</p>\n',
        '<a href="https://example.org/chaise/record/pseudo_column_schema:outbound_1_outbound_1/RID=' +
          utils.findEntityRID(options, schemaName, 'outbound_1_outbound_1', 'id', '01') +
          '">01</a>',
        '01',
        '',
        '',
    ...
    describe('columns list, ', function () {
        ...
        checkReferenceColumns([
          {
            ...
            expected: ['col', 'main_table_id_col', ['pseudo_column_schema', 'main_key1'].join('_'), ['pseudo_column_schema', 'main_fk1'].join('_')],
      ...
      it('in entry context, should ignore the pseudoColumns that are not supported.', function () {
        ...
        checkReferenceColumns([
          {
            ref: mainRefEntry,
            expected: ['main_table_id_col', 'col', ['pseudo_column_schema', 'main_fk1'].join('_'), 'asset'],
          },
        ]);
      });
        ...
        checkReferenceColumns([
          {
            ...
            expected: [
              ...
              ['pseudo_column_schema', 'main_fk1'].join('_'),
              [{ outbound: ['pseudo_column_schema', 'main_fk1'] }, 'id'],
              [{ outbound: ['pseudo_column_schema', 'main_fk1'] }, { outbound: ['pseudo_column_schema', 'outbound_1_fk1'] }, 'id'],
              [{ outbound: ['pseudo_column_schema', 'main_fk1'] }, { outbound: ['pseudo_column_schema', 'outbound_1_fk1'] }, 'id'],
              ...
              [{ outbound: ['pseudo_column_schema', 'main_fk2'] }, { outbound: ['pseudo_column_schema', 'outbound_2_fk1'] }, 'id'],
              '$virtual-column-1',
              '$virtual-column-1-1',
              [{ sourcekey: 'path_to_inbound_1_outbound_1_w_prefix' }, { outbound: ['pseudo_column_schema', 'inbound_1_outbound_1_fk1'] }, 'id'],
              [
                { inbound: ['pseudo_column_schema', 'main_inbound_2_association_fk1'] },
                { outbound: ['pseudo_column_schema', 'main_inbound_2_association_fk2'] },
                {
    ...
    describe('integration with other APIs, ', function () {
        ...
        describe('sort and paging, ', function () {
          describe('for one-to-one pseudoColumns, ', function () {
            ...
            it('next should be able to handle sorting based on pathColumns.', function (done) {
              mainRefDetailed
                .sort([{ column: detailedExpectedNames[4], descending: false }])
                .read(1)
                .then(function (res) {
      ...
      describe('.related and generateRelatedList, ', function () {
        ...
        it("related reference displayname should use the pseudo-column's displayname (markdown_name).", function () {
          var names = ['<strong>length 1 inbound</strong>', '<strong>association</strong>', '<strong>length 3 inbound</strong>'];
          ...
          .then(function (res) {
            ...
            expect(
              ...
              [
                'main_table_id_col',
                'col',
                'main_table_id_col', // the key
                [{ o: ['pseudo_column_schema', 'main_fk1'] }, 'RID'],
                [{ o: ['pseudo_column_schema', 'main_fk1'] }, 'id'], //entity:false
                [{ o: ['pseudo_column_schema', 'main_fk1'] }, { o: ['pseudo_column_schema', 'outbound_1_fk1'] }, 'id'],
                [{ o: ['pseudo_column_schema', 'main_fk1'] }, { o: ['pseudo_column_schema', 'outbound_1_fk1'] }, 'id'],
                'asset_filename',
                [{ o: ['pseudo_column_schema', 'main_fk2'] }, { o: ['pseudo_column_schema', 'outbound_2_fk1'] }, 'id'],
    ...
    describe('column APIs, ', function () {
      ...
      describe('hasPath, ', function () {
        ...
        it('otherwise it should be false.', function () {
          expect(detailedColsWTuple[14].hasPath).toBe(false);
        });
      });
      ...
      describe('isUnique, ', function () {
        ...
        it('otherwise should return false.', function () {
          expect(detailedColsWTuple[9].isUnique).toBe(false);
        });
      });
      ...
      describe('displayname, ', function () {
        ...
        describe('if it has aggreagte.', function () {
          it('should append the aggregate function to the displayname.', function () {
            var aggregateDisplaynames = ['# inbound_2', '# inbound_2_outbound_1', 'Min id', 'Max col name', 'id', 'inbound_2', 'inbound_2'];
            for (var i = 11; i <= 17; i++) {
      ...
      describe('comment, ', function () {
        ...
        it('if it has aggregate, should append the aggregate function to the column comment.', function () {
          var aggregateComments = [
            'Number of inbound_2',
            'Number of distinct inbound_2_outbound_1',
            'Minimum id',
            'Maximum col name',
            'List of id',
            'List of inbound_2',
            'List of distinct inbound_2',
          ];
          for (var i = 11; i <= 17; i++) {
            expect(detailedColsWTuple[i].comment).toEqual(
              {
      ...
      describe('compressedDataSource, ', function () {
        var detailedColumnCompressedDataSources = [
          ...
          [{ o: ['pseudo_column_schema', 'main_fk1'] }, { o: ['pseudo_column_schema', 'outbound_1_fk1'] }, 'id'], //5
          [{ o: ['pseudo_column_schema', 'main_fk1'] }, { o: ['pseudo_column_schema', 'outbound_1_fk1'] }, 'id'], //6
          ...
          [{ i: ['pseudo_column_schema', 'main_inbound_2_association_fk1'] }, 'id'], //10
          [
            { i: ['pseudo_column_schema', 'main_inbound_2_association_fk1'] },
            { o: ['pseudo_column_schema', 'main_inbound_2_association_fk2'] },
            'id',
          ...
          [{ i: ['pseudo_column_schema', 'main_inbound_2_association_fk1'] }, 'id'], //13
          'col', //14
          [
            { i: ['pseudo_column_schema', 'main_inbound_2_association_fk1'] },
            { o: ['pseudo_column_schema', 'main_inbound_2_association_fk2'] },
          ...
          [{ i: ['pseudo_column_schema', 'inbound_4_long_table_name_fk'] }, 'foreign key column name to main'], //21
          'asset', //22
          'asset_filename', //23
          [{ o: ['pseudo_column_schema', 'main_fk2'] }, { i: ['pseudo_column_schema', 'outbound_2_inbound_1_fk1'] }, 'id'], //24
          [{ o: ['pseudo_column_schema', 'main_fk2'] }, { o: ['pseudo_column_schema', 'outbound_2_fk1'] }, 'id'], //25
          null, // 26
          null, // 27
          [{ key: 'path_to_inbound_1_outbound_1_w_prefix' }, { o: ['pseudo_column_schema', 'inbound_1_outbound_1_fk1'] }, 'id'], //28
          [
            { i: ['pseudo_column_schema', 'main_inbound_2_association_fk1'] },
            { o: ['pseudo_column_schema', 'main_inbound_2_association_fk2'] },
            {
      ...
      describe('formatPresentation, ', function () {
        ...
        it("if it's not a one-to-one path, should return null.", function () {
          expect(detailedColsWTuple[9].formatPresentation({ main_table_id_col: '1', col: '1' }, 'detailed').value).toEqual('');
        });
        ...
        describe("if it's a one-to-one path", function () {
          ...
          describe('if in entity mode, ', function () {
            it('should apply the foreignkey logic.', function () {
              expect(detailedColsWTuple[5].formatPresentation({ col: 'A value', id: '101' }, 'detailed').value).toEqual(
                '<a href="https://example.org/chaise/record/pseudo_column_schema:outbound_1_outbound_1/id=101">101</a>',
                'index=5 missmatch.',
              );
            });

            it('should not apply the foreignkey logic if the show_foreign_key_link:false is defined.', function () {
              expect(detailedColsWTuple[25].formatPresentation({ col: 'A value', id: '101' }, 'detailed').value).toEqual('101', 'index=5 missmatch.');
            });
          });

          it('otherwise should apply the underlying column logic.', function () {
            expect(detailedColsWTuple[4].formatPresentation({ col: 'A value', id: '101' }, 'detailed').value).toEqual(
              '<p>101: A value</p>\n',
              'index=4 missmatch.',
            );

            expect(detailedColsWTuple[6].formatPresentation({ col: 'A value', id: '101' }, 'detailed').value).toEqual('101', 'index=6 missmatch.');
          });
        });
      });
      ...
      describe('getAggregatedValue, ', function () {
        ...
        var testGetAggregatedValue = function (index, value, isHTML, done) {
          detailedColsWTuple[index]
            .getAggregatedValue(mainPage)
            .then(function (val) {
        ...
        beforeAll(function () {
          ...
          inboundTwoValues = facets.map(function (facet, index) {
            return (
              '<a href="https://example.org/chaise/record/pseudo_column_schema:inbound_2/RID=' +
              utils.findEntityRID(options, schemaName, 'inbound_2', 'id', '0' + (index + 1)) +
              '">0' +
              (index + 1) +
              ', facet: ' +
              facet +
        ...
        describe('should honor the given array_display, ', function () {
          ...
          it('olist should return an ordered list.', function (done) {
            var value = ['<li>01</li>', '<li>02</li>', '<li>03</li>', '<li>04</li>', '<li>05</li>', '<li>06</li>', '<li>07</li>', '<li>08</li>'];
            value = '<ol>\n' + value.join('\n') + '\n</ol>\n';
        ...
        it('should handle empty result.', function (done) {
          var ref, cols;
          options.ermRest
            .resolve(mainEntityUriNoAggVal, { cid: 'test' })
            .then(function (response) {
      ...
      describe('reference, ', function () {
        it("should return the main reference if source doesn't have path", function () {
          expect(detailedColsWTuple[14].reference.location.uri).toBe(mainRefDetailed.location.uri);
        });
        ...
        it('should be generated based on mainTuple.', function () {
          checkReference(
            ...
            'outbound_1_outbound_1',
            {
              and: [
                {
                  source: [{ inbound: ['pseudo_column_schema', 'outbound_1_fk1'] }, { inbound: ['pseudo_column_schema', 'main_fk1'] }, 'RID'],
      ...
      describe('sourceObjectNodes, ', function () {
        it("if there's no path it should return an empty array.", function () {
          checkSourceObjectNodes(detailedColsWTuple[14], []);
        });
  ...
  function checkSortable(col, sortable, sortColumns, colStr) {
    ...
    if (sortColumns) {
      expect(
        col._sortColumns.map(function (col) {
  ...
  function checkSourceObjectNodes(col, sns, colStr) {
    ...
    expect(
      col.sourceObjectNodes.map(function (sn) {
