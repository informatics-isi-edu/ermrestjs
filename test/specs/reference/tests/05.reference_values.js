...
exports.execute = function (options) {
  describe("For determining 'tag:isrd.isi.edu,2016:column-display' presentation,", function () {
    ...
    var testObjects = {
      test1: {
        rowValue: [
          'id=4000, some_markdown= **date is :**, name=Hank, url= https://www.google.com, some_gene_sequence= GATCGATCGCGTATT, video_col= http://techslides.com/demos/sample-videos/small.mp4, catalog_snapshot_uri=schema:table, catalog_id_uri=schema:table',
        ],
        expectedValue: [
          '4000',
          '<h2>Hank</h2>\n',
          '<p><a href="https://www.google.com/Hank">link</a></p>\n',
          '<p><img src="http://example.com/4000.png" alt="image" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><img src="https://www.google.com/4000.png" alt="image with size" width="400" height="400" class="-chaise-post-load chaise-image-fallback"></p>\n',
      ...
      test2: {
        ...
        expectedValue: [
          ...
          '<p><img src="http://example.com/4001.png" alt="image" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><img src="/4001.png" alt="image with size" width="400" height="400" class="-chaise-post-load chaise-image-fallback"></p>\n',
      ...
      test3: {
        ...
        expectedValue: [
          ...
          null,
          '',
          '<p><img src="http://example.com/4002.png" alt="image" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><img src="https://www.google.com/4002.png" alt="image with size" width="400" height="400" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><a href="https://www.google.com" download="">download link</a></p>\n',
          '',
          '<p><strong>This is some markdown</strong> with some <code>code</code> and a <a href="http://www.example.com">link</a></p>\n',
          '',
      ...
      test4: {
        ...
        expectedValue: [
          ...
          null,
          '',
          '<p><img src="http://example.com/4003.png" alt="image" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><img src="/4003.png" alt="image with size" width="400" height="400" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><a href="" download="">download link</a></p>\n',
          '',
          '<p><strong>This is some markdown</strong> with some <code>code</code> and a <a href="http://www.example.com">link</a></p>\n',
          '',
      ...
      test5: {
        ...
        expectedValue: [
          ...
          '<h2>weird &amp; HTML &lt;</h2>\n',
          '<p>[link](/weird &amp; HTML &lt; )</p>\n',
          '<p><img src="http://example.com/4004.png" alt="image" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><img src="/4004.png" alt="image with size" width="400" height="400" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><a href="" download="">download link</a></p>\n',
      ...
      test6: {
        ...
        expectedValue: [
          ...
          '<p><img src="http://example.com/4005.png" alt="image" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><img src="/4005.png" alt="image with size" width="400" height="400" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><a href="" download="">download link</a></p>\n',
      ...
      test7: {
        ...
        expectedValue: [
          ...
          '<p><img src="http://example.com/4006.png" alt="image" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><img src="/4006.png" alt="image with size" width="400" height="400" class="-chaise-post-load chaise-image-fallback"></p>\n',
          '<p><a href="" download="">download link</a></p>\n',
    ...
    beforeAll(function (done) {
      ...
      options.ermRest
        .resolve(multipleEntityUri, { cid: 'test' })
    ...
    describe('Testing tuples values', function () {
      ...
      var setLinkRID = function (key) {
        ...
        switch (key) {
          case 'test2':
            rowValues[12] =
              '<p><a href="https://example.org/chaise/record/reference_schema:table_w_composite_key/RID=' +
              getRID(1) +
              '" class="class-10">4000 , 4001</a></p>\n';
            break;
          case 'test3':
            rowValues[12] =
              '<p><a href="https://example.org/chaise/record/reference_schema:table_w_composite_key/RID=' +
              getRID(2) +
              '" class="class-20">4000 , 4002</a></p>\n';
            break;
          case 'test4':
            rowValues[12] =
              '<p><a href="https://example.org/chaise/record/reference_schema:table_w_composite_key/RID=' +
              getRID(3) +
              '" class="class-30">4000 , 4003</a></p>\n';
            break;
          case 'test5':
            rowValues[12] =
              '<p><a href="https://example.org/chaise/record/reference_schema:table_w_composite_key/RID=' +
              getRID(4) +
              '" class="class-40">4001 , 4002</a></p>\n';
            break;
          case 'test6':
            rowValues[12] =
              '<p><a href="https://example.org/chaise/record/reference_schema:table_w_composite_key/RID=' +
              getRID(5) +
              '" class="class-50">4002 , 4000</a></p>\n';
            break;
          case 'test7':
            rowValues[12] =
              '<p><a href="https://example.org/chaise/record/reference_schema:table_w_composite_key/RID=' +
              getRID(6) +
              '" class="class-60">4000 , 4000</a></p>\n';
            break;
        }
      };
      ...
      var testTupleValidity = function (tupleIndex, key) {
        ...
        var columnNames = [
          ...
          'iframe',
          'some_markdown',
          'some_markdown_with_pattern',
          'some_gene_sequence',
          'column_using_invisble_column',
          'video_col',
          'fkeys_col',
          'catalog_snapshot',
          'moment_col',
    ...
    const expectedValues = [
      {
        ...
        col_markdown_blankable:
          '<p><a href="https://madeby.google.com/static/images/google_g_logo.svg" target="_blank"><img src="https://madeby.google.com/static/images/google_g_logo.svg" alt="" height="90" class="-chaise-post-load chaise-image-fallback"></a></p>\n',
      },
      {
        json_col: '{}',
        jsonb_col: '{}',
      ...
      },
      {
        ...
        col_markdown_blankable:
          '<p><a href="https://madeby.google.com/abc.jpeg" target="_blank"><img src="https://madeby.google.com/abc.jpeg" alt="" height="90" class="-chaise-post-load chaise-image-fallback"></a></p>\n',
      },
      {
        json_col: '2.9',
        jsonb_col: '2.9',
      ...
      },
      {
        ...
        col_markdown_blankable: '<p><a href="myurl" target="_blank"><img src="myurl" alt="" height="90" class="-chaise-post-load chaise-image-fallback"></a></p>\n',
      },
      {
        json_col:
    ...
    it('JSON column should display pre tags without markdown and should not append pre tag with markdown', function () {
      for (const [i, expected] of expectedValues.entries()) {
        ...
        expect(values[2]).toBe(
          expected.json_col_with_markdownpattern,
          'Mismatch in tuple with index = ' + i + ', column= json_col_with_markdownpattern',
        );
    ...
    describe('when markdown_pattern is missing.', function () {
      ...
      testValues([
        ...
        },
        {
          ...
          values: ['', '', '<p>false, <em>No value</em>, true</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
          column: 'date_array',
          values: ['', '', '<p>2016-01-18, <em>No value</em>, 2015-04-18</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
          column: 'timestamp_array',
          values: ['', '', '<p>2016-01-18 13:00:00, <em>No value</em>, 2015-02-18 16:00:00</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
        ...
        {
          column: 'float4_array',
          values: ['', '', '<p>2.4300, <em>No value</em>, 5.4213</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
          column: 'float8_array',
          values: ['', '', '<p>5,234.1234, <em>No value</em>, 4,123.2340</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
          column: 'numeric_array',
          values: ['', '', '<p>12,345.2340, <em>No value</em>, -41,232.2300</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
          column: 'int2_array',
          values: ['', '', '<p>1,245, <em>No value</em>, 6,242</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
          column: 'int4_array',
          values: ['', '', '<p>128,361, <em>No value</em>, 41,234</p>\n', '<p><em>No value</em></p>\n', ''],
        },
        {
          column: 'int8_array',
          values: ['', '', '<p>41,245,264, <em>No value</em>, 1,241,232</p>\n', '<p><em>No value</em></p>\n', ''],
        },
      ]);
    });
