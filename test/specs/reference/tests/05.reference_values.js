    ...
    describe("For determining 'tag:isrd.isi.edu,2016:column-display' presentation,", function () {
        ...
        describe('for tuple 0 with row values {"id":4000, "some_markdown": "** date is :**", "name":"Hank", "url": "https://www.google.com", "some_gene_sequence": "GATCGATCGCGTATT"},', function() {
            var values = ['4000',
                          ...
                          '<figure class="embed-block"><figcaption class="embed-caption">Hank caption</figcaption><iframe src="http://example.com/iframe" width="300" ></iframe></figure>',
        ...
        describe('for tuple 1 with row values {"id":4001, "name":"Harold","some_invisible_column": "Junior"},', function() {
            ...
            var values = ['4001',
                          ...
                          '<figure class="embed-block"><figcaption class="embed-caption">Harold caption</figcaption><iframe src="http://example.com/iframe" width="300" ></iframe></figure>',
        ...
        describe('for tuple 4 with row values {"id":4004, "name": "weird & HTML < " },', function() {
            ...
            var values = ['4004',
                          ...
                          '<p><a href="" download="">download link</a></p>\n',
                          '<figure class="embed-block"><figcaption class="embed-caption">weird &amp; HTML &lt;  caption</figcaption><iframe src="http://example.com/iframe" width="300" ></iframe></figure>',
                          '<p><strong>This is some markdown</strong> with some <code>code</code> and a <a href="http://www.example.com">link</a></p>\n',
        ...
        describe('for tuple 5 with row values {"id":4005, "name": "<a href=\'javascript:alert();\'></a>" , "some_invisible_column": "Senior"},', function() {
            ...
            var values = ['4005',
                          ...
                          '<p><a href="" download="">download link</a></p>\n',
                          '<figure class="embed-block"><figcaption class="embed-caption">&lt;a href=‘javascript:alert();’&gt;&lt;/a&gt; caption</figcaption><iframe src="http://example.com/iframe" width="300" ></iframe></figure>',
                          '<p><strong>This is some markdown</strong> with some <code>code</code> and a <a href="http://www.example.com">link</a></p>\n',
        ...
        describe('for tuple 6 with row values {"id":4006, "name": "<script>alert();</script>", "some_gene_sequence": "GATCGATCGCGTATT" , "some_invisible_column": "Sophomore"},', function() {
            ...
            var values = ['4006',
                          ...
                          '<p><a href="" download="">download link</a></p>\n',
                          '<figure class="embed-block"><figcaption class="embed-caption">&lt;script&gt;alert();&lt;/script&gt; caption</figcaption><iframe src="http://example.com/iframe" width="300" ></iframe></figure>',
                          '<p><strong>This is some markdown</strong> with some <code>code</code> and a <a href="http://www.example.com">link</a></p>\n',
