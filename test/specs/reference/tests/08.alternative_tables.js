...
exports.execute = function (options) {
  describe('For alternative tables,', function () {
    ...
    var uri1 = options.url + '/catalog/' + catalog_id + '/entity/' + schemaNameEncoded + ':' + baseTable1Encoded;

    var uri2 = options.url + '/catalog/' + catalog_id + '/entity/' + schemaNameEncoded + ':' + baseTable1Encoded + '/id=' + entityId;

    var uri3 =
      options.url + '/catalog/' + catalog_id + '/entity/' + schemaNameEncoded + ':' + baseTable2Encoded + '/id=' + entityId + '&value=' + value;
    ...
    var uri4 =
      ...
      ':' +
      baseTable1Encoded +
      '/id=00001;id=00002;id=00003;id=00004;id=00005;id=00006';

    var uri5 = options.url + '/catalog/' + catalog_id + '/entity/' + schemaNameEncoded + ':' + altDetailedTable1Encoded;

    var uri6 = options.url + '/catalog/' + catalog_id + '/entity/' + schemaNameEncoded + ':' + altDetailedTable1Encoded + '/id%20x=' + entityId;
    ...
    var uri8 =
      ...
      schemaNameEncoded +
      ':' +
      altDetailedTable1Encoded +
      '/id%20x=00001;id%20x=00002;id%20x=00003;id%20x=00004;id%20x=00005;id%20x=00006';

    var uri9 = options.url + '/catalog/' + catalog_id + '/entity/' + schemaNameEncoded + ':' + altCompactTable1Encoded;

    var uri10 = options.url + '/catalog/' + catalog_id + '/entity/' + schemaNameEncoded + ':' + altCompactTable1Encoded + '/id%20y=' + entityId;
    ...
    var uri12 =
      ...
      schemaNameEncoded +
      ':' +
      altCompactTable1Encoded +
      '/id%20y=00001;id%20y=00002;id%20y=00003;id%20y=00004;id%20y=00005;id%20y=00006';
    ...
    var uri15 =
      ...
      baseTable1Encoded +
      '/*::facets::' +
      options.ermRest.encodeFacet(facetObject15);
    ...
    var uri16 =
      ...
      altDetailedTable1Encoded +
      '/*::facets::' +
      options.ermRest.encodeFacet(facetObject16);

    var firstRowPathWithRID, secondRowPathWithRID, firstRowPathWithID, secondRowPathWithID;

    beforeAll(function () {
      firstRowPathWithRID =
        schemaNameEncoded + ':' + baseTable1Encoded + '/RID=' + utils.findEntityRID(options, schemaName, baseTable1, 'id', '00001');
      firstRowPathWithID = schemaNameEncoded + ':' + baseTable1Encoded + '/id=00001';
      secondRowPathWithRID =
        schemaNameEncoded + ':' + baseTable1Encoded + '/RID=' + utils.findEntityRID(options, schemaName, baseTable1, 'id', '00002');
    ...
    describe('1. base table with no entity filters,', function () {
      ...
      it('1.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri1, { cid: 'test' }).then(
          function (response) {
            reference = response;
      ...
      it('1.A.4 tuple read should return correct data from base table', function (done) {
        tuple.reference.read(limit).then(
          function (response) {
            page = response;
    ...
    describe('2. base table with single entity filter (single col key),', function () {
      ...
      it('2.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri2, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('3. base table with single entity filter (multi col key),', function () {
      ...
      it('3.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri3, { cid: 'test' }).then(
          function (response) {
            reference = response;
      ...
      it('3.B.3 tuple reference should be on the base table with correct filter', function () {
        ...
        expect(tuple.reference.displayname.value).toBe(baseTable2);
        var success =
          tuple.reference._location.path === schemaNameEncoded + ':' + baseTable2Encoded + '/id=00001&value=12' ||
    ...
    describe('4. base table with multiple entity filters,', function () {
      ...
      it('4.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri4, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('5. alternative detailed table with no entity filters,', function () {
      ...
      it('5.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri5, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('6. alternative detail table with single entity filter (single col key),', function () {
      ...
      it('6.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri6, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('7. alternative detail table with single entity filter (multi col key),', function () {
      ...
      it('7.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri7, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('8. alternative detail table with multiple entity filters,', function () {
      ...
      it('8.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri8, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('9. alternative compact table with no entity filters,', function () {
      ...
      it('9.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri9, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('10. alternative compact table with single entity filter (single col key),', function () {
      ...
      it('10.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri10, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('11. alternative compact table with single entity filter (multi col key),', function () {
      ...
      it('11.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri11, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('12. alternative compact table with multiple entity filters,', function () {
      ...
      it('12.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri12, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('13. related_table join on different keys with base with filter,', function () {
      ...
      it('13.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri13, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('14. related_table join on shared key with base with filter,', function () {
      ...
      it('14.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri14, { cid: 'test' }).then(
          function (response) {
            reference = response;
    ...
    describe('15. base table with facets, ', function () {
      ...
      it('15.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri15, { cid: 'test' }).then(
          function (response) {
            reference = response;
      ...
      it('15.A.4 tuple read should return correct data from base table', function (done) {
        tuple.reference.read(limit).then(
          function (response) {
            ...
            expect(page.tuples[0]._data).toEqual(
              jasmine.objectContaining({ id: '00002', name: 'Harold', value: 17, fk_to_related: '2' }),
              'data missmatch.',
            );
    ...
    describe('16. alternative detailed table with facets,', function () {
      ...
      it('16.1 resolve should return a Reference object that is defined.', function (done) {
        options.ermRest.resolve(uri16, { cid: 'test' }).then(
          function (response) {
            reference = response;
