    ...
    describe('should throw errors', function () {
      ...
      it('when reference is not contextualized for `entry/edit` should throw an error.', function (done) {
        ...
        return reference
          ...
          .then(function () {
            done.fail('Did not return any errors');
          })
          .catch(function (err) {
      ...
      it('should throw an error when no data was updated.', function (done) {
        ...
        reference
          ...
          .catch(function (err) {
            ...
            expect(err.message).toEqual('No data was changed in the update request. Please check the form content and resubmit the data.');
        ...
        reference
          ...
          .catch(function (err) {
            ...
            expect(err.message).toEqual(
              'No data was changed in the update request. Please check the form content and resubmit the data.',
