            ...
            describe('column defaults, ', function () {
                ...
                var tableName = "table_w_defaults",
                    columns = [
                        ...
                        { name: "timestamp_proper", value: options.ermRest._moment("2016-05-14 12:30:00").format("YYYY-MM-DD HH:mm:ss") },
                        { name: "timestamp_improper", value: null },
                        { name: "timestamptz_proper", value: options.ermRest._moment("2016-05-14 12:30:00-07").format("YYYY-MM-DD HH:mm:ssZ") },
