    ...
    describe('About the Column class, ', function() {
        ...
        describe('a column in Table class, ', function() {
            ...
            describe('the .getInputDisabled method, ', function() {
                var contexts, immutableCol, generatedCol;
                beforeAll(function() {
                ...
                it('in a create context, should return an object if the column is generated', function() {
                    var result = generatedCol.getInputDisabled(contexts.CREATE);
                    expect(typeof result).toEqual('object');
                    expect(result.hasOwnProperty('message')).toBe(true);
                    expect(result.message).toBe('Automatically generated by the server');
                });
