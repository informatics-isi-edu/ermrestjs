  ...
  describe('About the Column class, ', function () {
    ...
    describe('a column in Table class, ', function () {
      ...
      describe('the .getInputDisabled method, ', function () {
        var immutableCol, generatedCol, serialCol;
        beforeAll(function () {
        ...
        it('should return false if column is not generated or immutable or of serial type', function () {
          ...
          var result1 = column.getInputDisabled('entry/create');
          expect(result1).toBe(false);
          var result2 = column.getInputDisabled('entry/edit');
      ...
      describe('the .formatvalue property, ', function () {
        ...
        describe('when column value is null, ', function () {
          ...
          it('should return the value that is defined in its `show_null` display annotation based on context.', function () {
            runShowNullTestCases(columnWithAnnotation, { 'compact/brief': 'empty', detailed: '', 'entry/edit': null });
          });
        ...
        describe('should call printTimestamp() to format,', function () {
          it('timestamptz columns correctly.', function () {
            ...
            expect(formattedValue).toEqual(jasmine.any(String));
            expect(formattedValue).toBe(moment(testVal).format('YYYY-MM-DD HH:mm:ss'));
          });
        });
        ...
        describe('should call printColor() to format,', function () {
          it('color_rgb_hex columns correctly.', function () {
            ...
            testFormatvalue(
              'table_1_color_rgb_hex',
              '#00ff00',
              ':span: :/span:{.chaise-color-preview style=background-color:#00FF00} #00FF00',
              'valid value',
            );
          });
        });
          ...
          var cases = [
            {
              ...
              tests: [{ value: ['val 1', 'val 2', null, ''], expected: ['val 1', 'val 2', null, ''] }],
            },
            {
              type: 'boolean',
              column: 'table_1_boolean_array',
              tests: [{ value: [true, null, false], expected: ['true', null, 'false'] }],
            },
            {
              type: 'date',
              column: 'table_1_date_array',
              tests: [{ value: ['2016/05/02 13:00:00.00 PST', null, '2015/03/02 13:00:00.00 PST'], expected: ['2016-05-02', null, '2015-03-02'] }],
            },
            {
              type: 'timestamp',
            ...
            },
            {
              ...
              tests: [{ value: [31231.1, null, 2413.3], expected: ['31,231.1000', null, '2,413.3000'] }],
            },
            {
              type: 'float8',
              column: 'table_1_float8_array',
              tests: [{ value: [234523523.1, null, 241235.3], expected: ['234,523,523.1000', null, '241,235.3000'] }],
            },
            {
              type: 'numeric',
              column: 'table_1_numeric_array',
              tests: [{ value: [1223, null, 4133], expected: ['1,223.0000', null, '4,133.0000'] }],
            },
            {
              type: 'int2',
              column: 'table_1_int2_array',
              tests: [{ value: [4031, null, 32768], expected: ['4,031', null, '32,768'] }],
            },
            {
              type: 'int4',
              column: 'table_1_int4_array',
              tests: [{ value: [-2147483648, null, 214748364], expected: ['-2,147,483,648', null, '214,748,364'] }],
            },
            {
              type: 'int8',
              column: 'table_1_int8_array',
              tests: [{ value: [9007199254740991, null, 9007199254740990], expected: ['9,007,199,254,740,991', null, '9,007,199,254,740,990'] }],
            },
          ];
      ...
      describe('column defaults, ', function () {
        ...
        var tableName = 'table_w_defaults',
          nullColumns = [
            ...
            'int4_improper',
            'int8_improper',
            'color_rgb_hex_improper_1',
            'color_rgb_hex_improper_2',
            'RID',
            'RCB',
            'RMB',
            'RCT',
