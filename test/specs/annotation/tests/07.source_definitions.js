  ...
  describe('source definitions', function () {
    ...
    describe('fkeys', function () {
      it('when annotation is missing, should return all the foreignKeys.', function () {
        testForeignKeys(tableMainNoAnnot.sourceDefinitions.fkeys, [
          ['source_definitions_schema', 'main_no_annot_fk1'],
          ['source_definitions_schema', 'main_no_annot_fk2'],
        ]);
      });

      it('when annotation is defined and fkeys is true, shoruld return all the foreignKeys.', function () {
        testForeignKeys(tableMainTrue.sourceDefinitions.fkeys, [
          ['source_definitions_schema', 'main_true_col_true_fkeys_fk1'],
          ['source_definitions_schema', 'main_true_col_true_fkeys_fk2'],
        ]);
      });
      ...
      describe('when annotation is defined, ', function () {
        ...
        it('sourceMapping should be defined properly.', function () {
          ...
          var expectedSourceMapping = {
            ...
            DfGbmoqMIfSqDHRJasrtnQ: ['fk1_col_entity', 'fk1_col_entity_column_mapping', 'fk1_col_entity_remote_columns', 'fk1_col_entity_duplicate'],
            ...
            describe('related to path prefix, ', function () {
              ...
              it('should handle sources with path prefix that just change end column', function () {
                testSourceWrapperAPIs(
                  ...
                  true,
                  'alias',
                  ['left(id)=(source_definitions_schema:outbound2:id)', 'alias:=left(id)=(source_definitions_schema:outbound2_outbound1:id)'].join(
                    '/',
                  ),
                  [
                    { outbound: ['source_definitions_schema', 'main_fk2'] },
            ...
            describe('related to path prefix, ', function () {
              ...
              it('should handle sources with path prefix that just change end column', function () {
                testSourceWrapperAPIs(
                  ...
                  false,
                  '',
                  ['(id)=(source_definitions_schema:outbound2:id)', '(id)=(source_definitions_schema:main:id)'].join('/'),
                  [{ inbound: ['source_definitions_schema', 'outbound2_fk1'] }, { inbound: ['source_definitions_schema', 'main_fk2'] }],
                  'case 1',
                );
