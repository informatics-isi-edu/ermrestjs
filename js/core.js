...
var ERMrest = (function (module) {
    ...
    Column.prototype = {
        ...
        getInputDisabled: function(context) {
            if (context == module._contexts.CREATE) {
                ...
                // other contexts are not edit mode, so should return true.
                return true;
            }
            return false;
        }
    ...
    function PseudoColumn(foreignKey, column) {
        ...
        // if foreign key is simple, use the getInputDisabled of the column
        if (!foreignKey.simple) {

            this.getInputDisabled = function (context) {
                var cols = this.foreignKey.colset.columns, i, generated;
                if (context == module._contexts.CREATE) {
                    ...
                    for(i = 0 ; i < cols.length; i++) {
                        ...
                        // if one is not GENERATED
                        if (generated && !cols[i].annotations.contains(module._annotations.GENERATED)) {
                            generated = false;
                        }   
                    }
                    return generated;
